...
def get_products_by_image(image_path):
    ...
    messages = [
        {'role': 'system', 'content':
            ...
            '{"products": [{"name_original": название товара на языке оригинала, "name_en": перевод названия на англ, "name_ru": перевод названия на русский, "name_ua": перевод названия на украинский, "price": цена float, "category": категория товара}], '
